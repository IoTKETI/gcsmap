                    ...
                    <v-card ref="form">
                        ...
                        <v-card-text>
                            <v-container>
                                <v-row>
                                    <v-col cols="12" sm="6">
                                        <v-text-field ref="drone_host" v-model="host"
                                                      :rules="drone_host_rule" label="Drone Host*"
                        ...
                        <v-card-text>
                            <v-container>
                                <v-row>
                                    <v-col cols="12" sm="4">
                                        <v-text-field ref="drone_host" v-model="host"
                                                      :rules="drone_host_update_rule" label="Drone Host*"
                                                      required></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="4">
                                        <v-text-field disabled ref="drone_name" v-model="drone_name"
                                                      :rules="drone_name_update_rule" label="Drone Name*"
                                                      required></v-text-field>
                                    </v-col>
                                    <v-col cols="12" sm="4">
                                        <v-text-field disabled ref="drone_id" v-model="drone_id" :rules="drone_id_rule"
                                                      label="Drone ID*" hint="Unique ID of Drone" persistent-hint
                                                      required
                                        ></v-text-field>
                                    </v-col>
...
export default {
    ...
    data: function () {
        return {
            ...
            drone_name_rule: [
                ...
                v => !/[~!@#$%^&*()+|<>?:{}]/.test(v) || '드론 이름에는 특수문자를 사용할 수 없습니다.',
                v => (this.drone_infos.findIndex((element) => {
    ...
    methods: {
                                ...
                                axios({
                                    ...
                                    function () {
                                        axios({
                                            ...
                                            method: 'post',
                                            url: 'http://' + self.$store.state.VUE_APP_MOBIUS_HOST + ':7579/Mobius/' + self.$store.state.VUE_APP_MOBIUS_GCS + '/DroneInfos',
                                            headers: {
                                                'X-M2M-RI': String(parseInt(Math.random() * 10000)),
                                                'X-M2M-Origin': 'SVue',
        ...
        openCam2() {
            ...
            window.open("http://webrtc.iotocean.org", "_blank");
        },
